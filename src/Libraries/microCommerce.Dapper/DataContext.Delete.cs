...
namespace microCommerce.Dapper
{
    public partial class DataContext
    {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public virtual async Task<int> DeleteAsync<T>(T item, IDbTransaction transaction = null) where T : BaseEntity
        {
            string commandText = _provider.DeleteQuery(typeof(T).Name);
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public virtual async Task<int> DeleteBulkAsync<T>(IEnumerable<T> items, IDbTransaction transaction = null) where T : BaseEntity
        {
            string commandText = _provider.DeleteBulkQuery(typeof(T).Name);

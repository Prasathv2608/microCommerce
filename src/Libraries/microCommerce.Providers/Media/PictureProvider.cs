...
namespace microCommerce.Services.Media
{
    public class PictureProvider : IPictureProvider
    {
        ...
        protected virtual void SaveThumbToFile(string filePath, byte[] pictureBinary)
        {
            ...
            var thumbsDirectoryPath = _fileProvider.MapContentPath(ThumbFolderPath);
        ...
        protected virtual void DeletePictureThumbs(Picture picture)
        {
            ...
            var thumbDirectoryPath = _fileProvider.MapContentPath("~/content/images/thumbs");
        ...
        {
            return Path.Combine(_fileProvider.MapContentPath(PictureFolderPath), fileName);
        }
        ...
        {
            return Path.Combine(_fileProvider.MapContentPath(ThumbFolderPath), fileName);
        }
        ...
        {
            mimeType = ValidationHelper.EnsureNotNull(mimeType);
            mimeType = ValidationHelper.EnsureMaximumLength(mimeType, 20);

            seoFilename = ValidationHelper.EnsureMaximumLength(seoFilename, 100);
